...
class InstallmentOfferBottomSheet extends StatelessWidget {
  final int statusNum;
  final InstallmentPendingEntity offers;



  InstallmentOfferBottomSheet({super.key, required this.statusNum, required this.offers});
  final TextEditingController noteController = TextEditingController();

  @override
  Widget build(BuildContext context) {
    return BlocProvider.value(
      value: context.read<InstallmentPendingCubit>(),
      child: Padding(
                ...
                Expanded(
                  child: CustomizedElevatedButton(
                    onPressed: () async {
                      ...
                      try {
                        // Update offer status
                        await context.read<InstallmentPendingCubit>().updateInstallmentStatus(
                          id: offers.id,
                          status: statusNum,
                          adminNote: note,
                        );
                        ...
                        // Refresh the list
                        await context.read<InstallmentPendingCubit>().fetchPendingInstallments();
