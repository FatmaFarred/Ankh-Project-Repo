...
class StaticRoleData {
  ...
  final bool isActive;
// StaticRoleData isActive is true by default
  StaticRoleData({required this.roleName, this.isActive = true});
}

class TeamleaderCommissiomManagmentScreen extends StatefulWidget {
  final String? roleName; // Add roleName parameter
  
  const TeamleaderCommissiomManagmentScreen({Key? key, this.roleName}) : super(key: key);

  @override
  State<TeamleaderCommissiomManagmentScreen> createState() => _TeamleaderCommissiomManagmentScreenState();
}

class _TeamleaderCommissiomManagmentScreenState extends State<TeamleaderCommissiomManagmentScreen> {
  ...
  List<StaticRoleData> staticRoles = [
    StaticRoleData(roleName: 'LeaderMarketer'),
  ];
