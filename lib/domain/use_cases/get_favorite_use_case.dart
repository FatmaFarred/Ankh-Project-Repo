...
class GetFavoriteUseCase {
  ...
  GetFavoriteUseCase(this.repositry);

  Future <Either<Failure,List<ProductDetailsEntity>>>execute (String userId)async{
    return await repositry.getUserFavourite(userId);
