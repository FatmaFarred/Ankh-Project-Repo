...
class AcceptPointRequestUseCase{
  PointsRepositry repositry;
  AcceptPointRequestUseCase(this.repositry);

  Future <Either<Failure,String?>>execute (String token,String id )async{
    return await repositry.acceptPointRequest(token, id);
