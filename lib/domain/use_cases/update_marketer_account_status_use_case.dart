...
@injectable
class UpdateMarketerAccountStatusUseCase {
  MarketerAssignGetProductsRepositry repository;

  UpdateMarketerAccountStatusUseCase(this.repository);

  Future <Either<Failure,String?>> execute (num status,
      String userId) {
    return repository.updateMarketerAccountStatus(status, userId);
  }
}