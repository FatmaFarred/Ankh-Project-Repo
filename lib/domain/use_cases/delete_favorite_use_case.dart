...
class DeleteFavoriteUseCase {
  ...
  DeleteFavoriteUseCase(this.repositry);

  Future <Either<Failure,String?>>execute (String userId,num productId)async{
    return await repositry.removeFavourite(userId, productId);
