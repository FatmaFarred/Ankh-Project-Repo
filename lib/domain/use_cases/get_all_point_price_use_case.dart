...
class GetAllPointPriceUseCase{
  PointsRepositry repositry;
  GetAllPointPriceUseCase(this.repositry);

  Future <Either<Failure,List<AllPointPriceEntity>>>execute ()async{
    return await repositry.getAllPointPrice();
