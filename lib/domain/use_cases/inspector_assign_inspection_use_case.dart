...
@injectable
class InspectorAssignInspectionUseCase {
  HomeGetAllInspectionRepositry repository;

  InspectorAssignInspectionUseCase(this.repository);

  Future<Either<Failure, String?>> execute( num productId, String inspectorId ) {
    return repository.assignProdcutToInspector(productId, inspectorId);
  }
