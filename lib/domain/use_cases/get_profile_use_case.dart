...
class GetProfileUseCase{
  ...
  GetProfileUseCase(this.repositry);

  Future <Either<Failure,UserProfileEntity>>execute (String token,String userId)async{
    return await repositry.getUserData(token, userId);
