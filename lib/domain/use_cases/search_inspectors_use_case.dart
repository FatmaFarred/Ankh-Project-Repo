...
class SearchInspectorsUseCase{
  HomeGetAllInspectionRepositry repositry;
  SearchInspectorsUseCase(this.repositry);

  Future <Either<Failure,List<AllInspectorsEntity>>>execute ({required String keyWord})async{
    return await repositry.searchInspectors(keyWord);
