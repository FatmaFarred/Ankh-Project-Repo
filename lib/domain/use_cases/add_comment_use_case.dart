...
class AddCommentUseCase {
  ...
  AddCommentUseCase(this.repositry);

  Future <Either<Failure,String?>>execute (num productId,String token, comment)async{
    return await repositry.addComment(productId, token, comment);
