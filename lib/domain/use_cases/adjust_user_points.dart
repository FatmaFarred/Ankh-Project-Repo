...
class AdjustUserPointsUseCase {
  PointsRepositry repositry;
  AdjustUserPointsUseCase(this.repositry);

  Future <Either<Failure,String?>>execute (String userId, num points, String reason)async{
    return await repositry.adjustUserPoints(userId, points, reason);
